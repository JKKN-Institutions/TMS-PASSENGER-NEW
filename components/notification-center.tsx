      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute mt-3 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-100 z-50 overflow-hidden max-h-[70vh] sm:max-h-[80vh] overflow-y-auto notification-panel
              /* Mobile: Full width with margin */ 
              w-[calc(100vw-1rem)] left-[-calc(50vw-2rem)] sm:left-auto
              /* Desktop: Fixed width, right aligned */
              sm:w-80 lg:w-96 sm:right-0 sm:max-w-md"
          >
            {/* Enhanced Header */}
            <div className="bg-gradient-to-r from-blue-50 via-blue-50 to-purple-50 p-4 sm:p-6 border-b border-gray-100">
