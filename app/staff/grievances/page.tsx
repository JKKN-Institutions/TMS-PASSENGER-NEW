      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-gradient-to-r from-green-600 to-yellow-600 rounded-2xl p-8 text-white shadow-xl">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl md:text-3xl font-bold mb-2">Grievances Management</h1>
              <p className="text-white opacity-95 text-base md:text-lg">Handle student complaints and issues</p>
            </div>
