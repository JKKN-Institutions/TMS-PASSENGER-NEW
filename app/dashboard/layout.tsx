...
function DashboardContent({
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-green-50 via-yellow-50 to-green-100 overflow-hidden flex">
          ...
          <div className="border-t border-gray-100 p-6">
            <div className="flex items-center space-x-3 mb-4">
              <div className="relative">
                <div className="h-10 w-10 rounded-full bg-gradient-to-r from-green-600 to-yellow-500 flex items-center justify-center shadow-md">
      ...
      <div className="hidden lg:flex lg:w-80 lg:flex-col lg:fixed lg:inset-y-0 bg-white border-r border-gray-200">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-100">
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 bg-gradient-to-r from-green-600 to-yellow-500 rounded-xl flex items-center justify-center shadow-md">
        ...
        <div className="border-t border-gray-100 p-6">
          <div className="flex items-center space-x-3 mb-4">
            <div className="relative">
              ...
              />
              <div className="hidden h-10 w-10 rounded-full bg-gradient-to-r from-green-600 to-yellow-500 flex items-center justify-center shadow-md">
                <span className="text-sm font-bold text-white drop-shadow-sm">
                  {user?.full_name?.charAt(0).toUpperCase()}
                </span>
              </div>
      ...
      <div className="lg:pl-80 flex flex-col h-full flex-1 min-w-0">
        ...
        <div className="bg-white/80 backdrop-blur-xl border-b border-gray-200 flex h-16 flex-shrink-0 items-center justify-between px-4 sm:px-6 min-w-0">
            ...
            <div className="flex items-center space-x-4">
              <div className="relative">
                <input
                  ...
                  className="w-64 lg:w-80 xl:w-96 pl-4 pr-10 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-3 focus:ring-green-200 focus:border-green-500 transition-all duration-200"
                />
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            <div className="relative">
              <div className="h-8 w-8 rounded-full bg-gradient-to-r from-green-600 to-yellow-500 flex items-center justify-center cursor-pointer hover:from-green-700 hover:to-yellow-600 transition-all duration-200 shadow-md">
        ...
        {/* Page content */}
        <main className="flex-1 overflow-y-auto bg-gradient-to-br from-green-50 via-yellow-50 to-green-100 min-w-0 main-content">
