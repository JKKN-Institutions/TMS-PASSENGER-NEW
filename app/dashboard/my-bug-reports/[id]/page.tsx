...
const BugReportDetailPage: React.FC = () => {
  ...
  const fetchBugReportDetail = async () => {
    try {
      ...
      // In a real implementation, you would fetch the specific report details
      // For now, we'll fetch all reports and filter
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-6">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <button
                  onClick={() => router.push('/dashboard/my-bug-reports')}
